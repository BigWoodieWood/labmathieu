/**
 * @file screen.hpp
 * @brief Declaration of class TScreen - Console display management
 * @author elliot wood
 * @date 26 October 2025
 * @version 1.0
 *
 * This class manages displaying information on the screen for real-time
 * tasks. It provides a thread-safe display interface.
 */
