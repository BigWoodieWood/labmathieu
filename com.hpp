/**
 * @file com.hpp
 * @brief Declaration of class TCom - Serial and network communication
 * @author elliot wood
 * @date 26 October 2025
 * @version 1.0
 *
 * This class handles serial and network communications for real-time tasks.
 * It inherits from TThread and provides interfaces for several protocols
 * (serial, UDP, TCP, MQTT).
 */
